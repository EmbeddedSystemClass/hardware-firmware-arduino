	...
	public class DataLogger {
        ...
        public bool TryWriteFile(string fileName)
        {
            ...
            if (tryGetPort(out port))
            {
                ...
                // serial communication				
                port.Write(signature, 0, SIGNATURESIZE);
                port.Write(writeFile, 0, DATASIZE);
                ...
                for (; ; )
                {
                    ...
                    int read = file.Read(buffer, 0, 10);
                    ...
                    ReportProgress((int)((float)totalRead / file.Length * 100.0f));
                }

                byte[] fileStopp = Encoding.ASCII.GetBytes("</FILE>*DUMMY**DUMMY**DUMMY**DUMMY**DUMMY**DUMMY*");
                port.Write(fileStopp, 0, fileStopp.Length);
